...
__all__ = [
    'Bangladesh_Cyclone_Set1_BGWTC4SS1KeysLookup'
]
...
class Bangladesh_Cyclone_Set1_BGWTC4SS1KeysLookup(CatrisksBaseKeysLookup):
    """
    ...
    @oasis_log()
    def __init__(self, keys_data_directory=None, supplier='UKMO&BUET', model_name='BGWTCSS1', model_version=None,**kwargs):
